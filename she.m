...
%{
R_AC_BD = VoltageBD(2:3:end)./samplecurrentAC(2:3:end);
R_BD_CA = VoltageAC(2:3:end)./samplecurrentBD(2:3:end);
R_H_prop = (R_AC_BD+R_BD_CA)./BFieldGauss(2:3:end);
R_H = -1.25*.5*R_H_prop*10;
scatter(TemperatureK(2:3:end),R_H);
%}
